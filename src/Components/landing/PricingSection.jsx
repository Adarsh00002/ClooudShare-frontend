        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          {pricingPlans.map((plan, index) => (
            ...
            <div
              ...
              ${plan.highlighted 
                ? 'border-2 border-purple-500 scale-105 bg-white' 
            ...
            >
              ...
              {/* Top */}
              <div className={`relative px-6 py-8 ${plan.highlighted ? 'bg-gradient-to-br from-purple-50 to-white' : ''}`}>
              ...
              {/* Bottom */}
              <div className="relative flex-1 flex flex-col justify-between px-6 pb-8 bg-gray-50 space-y-6">
                
                <ul className="space-y-4">
                  {plan.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-start group/item">
                      
                      <Check className="h-5 w-5 text-purple-500 group-hover/item:scale-110 transition-transform duration-200" />
                ...
                <div className="rounded-md">
                  <button
                    ...
                    ${plan.highlighted
                      ? 'text-white bg-purple-500 hover:bg-purple-600 shadow-lg hover:shadow-xl'
                      : 'text-purple-600 bg-white border border-purple-500 hover:bg-purple-50'
                    }`}
                  >
                    {plan.cta}
                  </button>
